...
const FIELDS = [
      {
            ...
            "type": "text",
            "required": true,
            "placeholder": "Path to JSON file or '-' for stdin",
            "help": "Path to JSON file or '-' for stdin"
      }
];

export default function ParseInvoiceInputPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      >
        <h1 className="font-heading text-3xl font-bold mb-2">Parse Invoice Input</h1>
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-8">
        <div className="card">
          ...
          <ToolForm
            toolName="Parse Invoice Input"
            fields={FIELDS}
            apiEndpoint="/api/parse-invoice-input"
