...
const FIELDS = [
      {
            ...
            "type": "text",
            "required": false,
            "placeholder": "output/published",
            "help": "Path to directory containing published result files"
      },
      {
            "name": "failed_dir",
            ...
            "type": "text",
            "required": false,
            "placeholder": "output/failed",
            "help": "Path to directory containing failed result files"
      }
];
...
export default function GenerateReportPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      >
        <h1 className="font-heading text-3xl font-bold mb-2">Generate Report</h1>
        <p className="mb-8" style={{ color: 'var(--text-secondary)' }}>
          Generate markdown summary reports with success rates and actionable recommendations.
        </p>
      </motion.div>
