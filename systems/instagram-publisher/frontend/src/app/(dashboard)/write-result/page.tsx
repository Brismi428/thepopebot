...
const FIELDS = [
      {
            ...
            "type": "textarea",
            "required": true,
            "placeholder": '{"status": "published", "post_id": "123", "permalink": "https://..."}',
            "help": "JSON object with publish result data"
      },
      {
            "name": "output_dir",
...
export default function WriteResultPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      >
        <h1 className="font-heading text-3xl font-bold mb-2">Write Result</h1>
        <p className="mb-8" style={{ color: 'var(--text-secondary)' }}>
          Write publish results to output directories with automatic status routing.
        </p>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-8">
        <div className="card">
          ...
          <ToolForm
            toolName="Write Result"
            fields={FIELDS}
            apiEndpoint="/api/write-result"
