...
const FIELDS = [
      {
            ...
            "help": "JSON object with caption, image_url, and business_account_id"
      }
];
...
export default function ValidateContentPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      >
        <h1 className="font-heading text-3xl font-bold mb-2">Validate Content</h1>
        <p className="mb-8" style={{ color: 'var(--text-secondary)' }}>
          Validate content against Instagram requirements including caption length, hashtags, and image accessibility.
        </p>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-8">
        <div className="card">
          ...
          <ToolForm
            toolName="Validate Content"
            fields={FIELDS}
            apiEndpoint="/api/validate-content"
