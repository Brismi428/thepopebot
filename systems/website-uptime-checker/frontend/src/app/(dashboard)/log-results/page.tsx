...
const FIELDS = [
      {
            ...
            "type": "text",
            "required": true,
            "placeholder": "JSON file or string with check results",
      ...
      },
      {
            ...
            "type": "text",
            "required": false,
            "placeholder": "CSV log file path",
            "help": "CSV log file path",
            "defaultValue": "logs/uptime_log.csv"
      }
];
...
export default function LogResultsPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      >
        <h1 className="font-heading text-3xl font-bold mb-2">Log Results</h1>
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-8">
        <div className="card">
          ...
          <ToolForm
            toolName="Log Results"
            fields={FIELDS}
            apiEndpoint="/api/log-results"
