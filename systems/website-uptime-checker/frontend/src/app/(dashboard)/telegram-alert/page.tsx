...
export default function TelegramAlertPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      >
        <h1 className="font-heading text-3xl font-bold mb-2">Telegram Alert</h1>
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-8">
        <div className="card">
          ...
          <ToolForm
            toolName="Telegram Alert"
            fields={FIELDS}
            apiEndpoint="/api/telegram-alert"
