...
// 3 tools chained automatically
      ...
      <section id="features" className="px-6 py-24 md:px-8 lg:px-12" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card">
              <h3 className="font-heading font-semibold mb-2">Log Results</h3>
              <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>CSV logging tool for uptime check results.</p>
            </div>

            <div className="card">
              <h3 className="font-heading font-semibold mb-2">Monitor</h3>
              <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Website uptime monitor tool.</p>
            </div>

            <div className="card">
              <h3 className="font-heading font-semibold mb-2">Telegram Alert</h3>
              <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Telegram alert tool for website downtime notifications.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-24 md:px-8 lg:px-12 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
          Run Website Uptime Checker — Operating Instructions tools individually or as a complete pipeline.
        </p>
        <Link href="/dashboard/" className="btn-primary inline-flex items-center gap-2">
